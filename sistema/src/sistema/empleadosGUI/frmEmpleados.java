...
public class frmEmpleados extends javax.swing.JFrame {
    ...
    public frmEmpleados() {
        ...
        String[] titulos = {"ID", "Nombre", "Cargo", "Correo"};
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        String strSentenciaInsert = String.format("INSERT INTO empleados (ID, Nombre,Cargo,Correo)"
                + "VALUES (null, '%s','%s','%s')", oEmpleados.getNombre(), oEmpleados.getCargo(), oEmpleados.getCorreo());
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        String strSentenciaEdit = String.format("UPDATE empleados SET Nombre='%s'," + "Apellido='%s',"
                + "Correo='%s' WHERE ID = %d", oEmpleados.getNombre(), oEmpleados.getCargo(), oEmpleados.getCorreo(), oEmpleados.getID());
    ...
    public void mostrarDatos() {
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                Object[] oUsuario = {resultado.getString("ID"), resultado.getString("Nombre"), resultado.getString("Cargo"), resultado.getString("Correo")};
